...
class OnLoaderCompleted {
    ...
    static URL createUrl() {
        ...
        try {
            ...
            Log.e("OnLoaderCompleted", "Error creating URL: ", e);
            return null;
        }
    }
    ...
    private static String formatDate(String rawDate) {
            ...
            try {
                ...
                Log.e("OnLoaderCompleted", "Error parsing JSON date: ", e);
                return "";
            }
    }
    ...
    static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            Log.e("Onloadercompleted", "Error making HTTP request: ", e);
        } finally {
    ...
    static List<News> parseJson(String response) {
        ...
        try {
            ...
            Log.e("Onloadercompleted", "Error parsing JSON response", e);
        }
        return listOfNews;
    }
}
